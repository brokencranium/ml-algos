...
if __name__ == '__main__':
    ...
    lr_model = LinearRegression(x_dim=X_train.shape[1], learning_rate=0.01)

    sess = tf.Session(graph=lr_model.g)
    training_costs = train_linreg(sess, lr_model, X_train, y_train)
